...
forge script script/Hyperlane/DeployCounter.s.sol:DeployCounterScript --rpc-url $RPC_GOERLI
forge script script/Hyperlane/CounterSourceTx.s.sol:CounterSourceTxScript --rpc-url $RPC_MUMBAI
